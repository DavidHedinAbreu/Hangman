...
public class GameFrame extends JFrame {
    ...
    private JLabel prompt, header, guessedLetters;
    ...
    public GameFrame() {
        ...
        guessedLetters.setSize(new Dimension(200, 30));
		guessedLetters.setFont(new Font("Dialog", Font.BOLD, 20));
    ...
    public JLabel getGuessedLabel() { return guessedLetters; }
